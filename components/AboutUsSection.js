  ...
  <section className="py-20 bg-gray-50">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="mt-4 text-lg text-gray-600 text-left">
          Our goal is to provide the knowledge and training needed to stay safe for a lifetime. At Melbourne West Driving School, we create a relaxed and friendly learning environment where you can focus on your driving. We use a variety of teaching methods to suit your learning style—keeping things simple, clear, and easy to understand. With both male and female instructors available, we ensure every learner feels comfortable and confident throughout their journey.
        </p>
      </div>
    </div>
  </section>
